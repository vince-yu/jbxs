//
//  SDSystemDetailViewController.m
//  sndonongshang
//
...
@interface SDSystemDetailViewController ()
@end

@implementation SDSystemDetailViewController
...
- (SDDetailTableView *)tableView{
    if (!_tableView) {
        _tableView = [[SDSystemDetailTableView alloc] initWithFrame:CGRectZero style:UITableViewStylePlain goodModel:self.goodModel];
...
- (SDGoodBarView *)barView{
    if (!_barView) {
        SDGoodBarStyle type = SDGoodBarStyleGroupBuyRemind;
