...
//    NSMutableArray *sectionTitlesM = [NSMutableArray array];
//    for (NSString *title in sectionTitles) {
//        if (title.length > 6) {
//            SNDOLOG(@"title %@", title);
//            [sectionTitlesM addObject:[title substringToIndex:6]];
//        }else {
//            [sectionTitlesM addObject:title];
//        }
//    }
    ...
    if (self.selectionStyle == HMSegmentedControlSelectionStyleArrow) {
        ...
        if (self.selectionStyle == HMSegmentedControlSelectionStyleTextWidthStripe &&
            ...
            if (self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleDynamic) {
                ...
                CGFloat left = ([[self.segmentWidthsArray objectAtIndex:self.selectedSegmentIndex] floatValue] - self.selectionIndicatorEdgeInsets.right - sectionWidth) / 2.0;
                return CGRectMake(selectedSegmentOffset + left, indicatorYOffset, sectionWidth, self.selectionIndicatorHeight + self.selectionIndicatorEdgeInsets.bottom);
